...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvasEl: HTMLCanvasElement) {
      ...
      const isWebGL2 = !!gl;
      if (!isWebGL2) {
        gl = (canvasEl.getContext('webgl', params) || canvasEl.getContext('experimental-webgl', params)) as any;
      }
    ...
    function handleMouseDown(e: MouseEvent) {
      ...
      const pos = isAbsolute ? getPointerPos(e.clientX, e.clientY) : { x: scaleByPixelRatio(e.clientX), y: scaleByPixelRatio(e.clientY) };
    ...
    function handleTouchStart(e: TouchEvent) {
      ...
      for (let i = 0; i < touches.length; i++) {
        const pos = isAbsolute ? getPointerPos(touches[i].clientX, touches[i].clientY) : { x: scaleByPixelRatio(touches[i].clientX), y: scaleByPixelRatio(touches[i].clientY) };
