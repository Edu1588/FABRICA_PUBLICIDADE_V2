    ...
    <>
      ...
      <div className="fixed inset-0 z-40 pointer-events-none p-6 md:p-10 flex flex-col justify-between text-[#F5F2EC]">
        ...
        <div className="flex justify-between items-center pointer-events-auto w-full">
          ...
          <a href="/home" className="flex items-center gap-3 cursor-pointer group bg-black/60 backdrop-blur-md px-3.5 py-1.5 rounded-full border border-white/10 hover:border-[#ff4f00] transition-colors">
            <span className="text-xl font-bold text-[#ff4f00] tracking-tighter font-serif">F</span>
            <span className="text-xs font-mono tracking-widest text-white/90 group-hover:text-[#ff4f00] transition-colors uppercase">FÁBRICA</span>
          </a>

          {/* Center Control Box */}
          <div 
            className="flex items-center gap-4 text-[10px] md:text-xs bg-black/80 backdrop-blur-md px-5 py-2.5 rounded-full border border-white/15 uppercase tracking-widest cursor-pointer hover:border-[#ff4f00] transition-all group shadow-2xl" 
          ...
          {/* Right Language & Status Corner */}
          <div className="flex items-center gap-4 bg-black/60 backdrop-blur-md px-3.5 py-1.5 rounded-full border border-white/10">
            <button 
              onClick={toggleLanguage}
              className="flex items-center gap-1.5 text-[10px] font-mono tracking-widest uppercase hover:text-[#ff4f00] transition-colors"
            >
